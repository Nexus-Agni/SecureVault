          ...
          <Card className="w-full max-w-110 border-red-500/20 bg-linear-to-br from-stone-900/95 via-black/95 to-stone-900/95 shadow-[0_0_60px_rgba(239,68,68,0.25),0_0_100px_rgba(239,68,68,0.1)] backdrop-blur-xl">
            <CardHeader className="text-center px-4 sm:px-6 pt-6">
              <div className="mx-auto mb-3 sm:mb-4 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full border-2 border-red-500/40 bg-linear-to-br from-red-500/20 to-red-600/10 text-red-400 shadow-[0_0_30px_rgba(239,68,68,0.3)]">
                <FaLock className="h-6 w-6 sm:h-7 sm:w-7" />
              </div>
              <CardTitle className="text-2xl sm:text-3xl text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">Reset Password</CardTitle>
              <CardDescription className="text-stone-400 text-sm sm:text-base">Enter your new password below.</CardDescription>
            </CardHeader>
            <CardContent className="px-4 sm:px-6">
              <form onSubmit={handleResetPassword} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  <Label htmlFor="newPassword" className="text-stone-200 text-sm sm:text-base">New Password</Label>
